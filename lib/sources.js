...
export const FEEDS = [
  ...
  // English: anchor "Vodafone" to Egypt (or the Cash product) so we don't pull in
  // global Vodafone Group news. Arabic: the bare brand name is safe — Arabic-
  // language Vodafone coverage is almost entirely Egyptian, and most of it never
  // uses the exact phrase "فودافون مصر", which is why the strict query missed it.
  ...
  { id: 'or-eg-ar', tier: 1, brand: 'Orange', country: 'Egypt',
    url: gnews('أورنج OR اورنج OR أورنچ', 'ar') },
