...
export const FEEDS = [
  ...
  { id: 'vf-eg-en', tier: 1, brand: 'Vodafone', country: 'Egypt',
    url: gnews('"Vodafone Egypt" OR "Vodafone Cash" Egypt') },
  { id: 'vf-eg-ar', tier: 1, brand: 'Vodafone', country: 'Egypt',
    url: gnews('"فودافون مصر" OR "فودافون كاش"', 'ar') },

  // ---- Orange Egypt ----
  { id: 'or-eg-en', tier: 1, brand: 'Orange', country: 'Egypt',
    url: gnews('"Orange Egypt" OR "Orange Money" Egypt') },
  { id: 'or-eg-ar', tier: 1, brand: 'Orange', country: 'Egypt',
    url: gnews('"أورنچ مصر" OR "اورنج مصر"', 'ar') },
