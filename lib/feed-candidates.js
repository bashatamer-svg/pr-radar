...
export const FEED_CANDIDATES = [
  ...
  { id: 'hapi', name: 'Hapi Journal', kind: 'business', urls: ['https://hapijournal.com/feed/', 'https://hapijournal.com/rss'] },
  { id: 'enterprise', name: 'Enterprise', kind: 'business', urls: ['https://enterprise.press/feed/', 'https://enterprise.press/rss'] },
  { id: 'dne-all', name: 'Daily News Egypt (all)', kind: 'business', urls: ['https://www.dailynewsegypt.com/feed/'] },
  ...
  { id: 'arabhardware', name: 'Arab Hardware', kind: 'telecom', urls: ['https://www.arabhardware.net/feed', 'https://arabhardware.net/feed'] },
  ...
  { id: 'developingtelecoms', name: 'Developing Telecoms', kind: 'telecom', urls: ['https://developingtelecoms.com/index.php?format=feed&type=rss', 'https://www.developingtelecoms.com/rss'] },
  { id: 'commsupdate', name: 'TeleGeography CommsUpdate', kind: 'telecom', urls: ['https://www.commsupdate.com/feed/'] },
  { id: 'digitalboom', name: 'Digital Boom', kind: 'telecom', urls: ['https://www.adigitalboom.com/feed/', 'https://adigitalboom.com/feed/'] },
  ...
  { id: 'almasryalyoum', name: 'Al-Masry Al-Youm', kind: 'general', urls: ['https://www.almasryalyoum.com/rss/rssfeeds', 'https://www.almasryalyoum.com/rss'] },
  ...
  { id: 'ntra', name: 'NTRA', kind: 'official', urls: ['https://www.tra.gov.eg/rss', 'https://tra.gov.eg/feed'] },
